...
| TEST-059 | Grep regex extended | `shed_exec(zone="storage", cmd="grep", args=["-E", "error\|warning",...` | ✓ success | ✅ |
...
| TEST-897 | Injection pipe | `shed_exec(zone="storage", cmd="cat", args=["file.txt \| cat /etc/pa...` | ✗ ARGUMENT_FORBIDDEN | ✅ |
